...
var SCREENSHOTS = (function () {
	...
	var css =
		'#screenshot-container{background:#eee;width:480px;height:360px;overflow:hidden;position:relative;}';
	...
	if (stage) {
		...
		imageContainer.innerHTML = '<img id="image" style="clear:both;display:none;border:black solid 1px;width: 100%;height: 100%;">';
	...
	screenshot.addEventListener('click', function () {
		...
		v.clientWidth = v.clientWidth;
		v.clientHeight = v.clientHeight;
